    ...
    <div>
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-xl sm:text-2xl font-semibold">Cron Zamanlayıcı</h2>
        </div>
      ...
      <div className="bg-gray-900 rounded-xl border border-gray-800 p-4 mb-4">
        <h3 className="text-sm font-medium mb-3">Yeni Zamanlanmış Görev</h3>
        ...
        <div className="flex flex-col sm:flex-row gap-2 mb-2">
          ...
          <input value={command} onChange={e => setCommand(e.target.value)}
            ...
            placeholder="Komut (örn: /usr/bin/backup.sh)"
      ...
      <div className="bg-gray-900 rounded-xl border border-gray-800">
        <div className="px-4 py-2.5 border-b border-gray-800 text-xs text-gray-500 font-medium uppercase tracking-wider flex items-center justify-between">
          <span>Zamanlanmış Görevler ({jobs.length})</span>
        </div>
        {jobs.length === 0 ? (
          <div className="p-8 text-center text-gray-600">
            <Clock size={32} className="mx-auto mb-2 opacity-30" />
            <p>Hiç cron job yok</p>
            <p className="text-xs mt-1">Yukarıdan yeni bir görev ekleyin</p>
          </div>
        ) : (
