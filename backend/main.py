...
app.include_router(system.router, prefix="/api", dependencies=[Depends(require_auth)])
...
app.include_router(terminal.router, prefix="/api", dependencies=[Depends(require_auth)])
...
app.include_router(pentest.router, prefix="/api", dependencies=[Depends(require_auth)])
...
app.include_router(ollama.router, prefix="/api", dependencies=[Depends(require_auth)])
